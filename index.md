...
| LogitBoost |  <img src="https://render.githubusercontent.com/render/math?math=log_2[1 &plus; e^{-2yf}]">  |    <img src="https://render.githubusercontent.com/render/math?math=y \in \left\lbrace -1, +1 \right\rbrace">     |  <img src="https://render.githubusercontent.com/render/math?math=F(x)=\frac{1}{2}log\left(\frac{\mathbb{P}(Y=1\|X=x)}{\mathbb{P}(Y=-1\|X=x)}\right)">   |
