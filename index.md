...
|:----------:|:--------------------:|:---------------------------------------------------------:|:--------------------------------------------------------------------:|
|  AdaBoost  |      <img src="https://render.githubusercontent.com/render/math?math=exp(yf)">      |         $`y \in \left\lbrace -1, +1 \right\rbrace`$         | $`F(x) = \frac{1}{2}log\left(\frac{P(Y=1\|X=x)}{P(Y=-1\|X=x)}\right)`$ |
